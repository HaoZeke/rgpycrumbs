...
_DEPENDENCY_MAP: dict[str, str] = {
    ...
    "chemparseplot": "chemparseplot[neb,plot]>=1.9.15,<2",
    "chemparseplot.plot": "chemparseplot[neb,plot]>=1.9.15,<2",
    "chemparseplot.plot.chemgp": "chemparseplot[neb,plot]>=1.9.15,<2",
