...
_DEPENDENCY_MAP: dict[str, str] = {
    ...
    "chemparseplot": "chemparseplot[neb,plot]>=1.9.13,<2",
    "chemparseplot.plot": "chemparseplot[neb,plot]>=1.9.13,<2",
    "chemparseplot.plot.chemgp": "chemparseplot[neb,plot]>=1.9.13,<2",
    "chemparseplot.plot.neb": "chemparseplot[neb,plot]>=1.9.13,<2",
    "chemparseplot.plot.optimization": "chemparseplot[neb,plot]>=1.9.13,<2",
    "chemparseplot.parse": "chemparseplot[neb,plot]>=1.9.13,<2",
