...
- Script :: handled on-the-fly via the ~uv~ dispatching mechanism and PEP 751 detailed in my [[https://realpython.com/python-script-structure/][RealPython best practices post]].
