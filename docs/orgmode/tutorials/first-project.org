#+TITLE: First Project - End-to-End Energy Landscape Analysis
...
This tutorial walks you through a complete workflow: from raw NEB calculation
output to a publication-quality energy landscape figure. We'll use a surface
diffusion problem as our example.
...
See also:
- @@rst::doc:`tools/eon/plt_neb`@@ for NEB plotting options
- @@rst::doc:`tools/surfaces`@@ for surface fitting details
- @@rst::doc:`tools/eon/con_splitter`@@ for trajectory processing
